...
class ProjectsPage:
    def __init__(self, page: Page):
        ...
        self._project_cards = page.locator("#grid ul > li")
    ...
    def projects_not_empty(self):
        expect(self._project_cards).not_to_have_count(0)
    ...
    def get_all_projects(self) -> list[ProjectCard]:
        return [
            ProjectCard(card)
            for card in self._project_cards.all()
        ]
    ...
    def visible_project_cards(self) -> Locator:
        return self._project_cards.filter(
